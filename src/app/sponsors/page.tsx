...
import rice from '../../../public/sponsors/rice.png'
...
export default function Members() {
    const sponsors = [
        ...
        { src: rice, alt: "Rice Neuroengineering Initiative", link: "https://ugresearch.ucsd.edu/" },
    ...
    return (
        <main className="flex flex-col min-h-screen pt-20">
            ...
            <div className="flex-grow py-10 flex flex-col justify-center items-center">
                ...
                {/* 2x2 Grid Layout */}
                <div className="w-full max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-0 gap-y-12">
                    {sponsors.map((sponsor, index) => (
                        <a key={index} href={sponsor.link} target="_blank" rel="noopener noreferrer" 
                        className={`flex justify-center ${sponsors.length % 2 !== 0 && index === sponsors.length - 1 ? 'sm:col-span-2' : ''}`}>
